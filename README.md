...
`Python` `FastAPI` `Django` `Node.js` `REST API` `GraphQL` `gRPC`
...
`Docker` `Linux` `GitHub Actions` `CI/CD` `Nginx`
...
<img src="https://github-readme-stats.vercel.app/api?username=ТВОЙ_USERNAME&show_icons=true&theme=dark&hide_border=true">

<br>

<img src="https://github-readme-streak-stats.herokuapp.com/?user=ТВОЙ_USERNAME&theme=dark&hide_border=true">
